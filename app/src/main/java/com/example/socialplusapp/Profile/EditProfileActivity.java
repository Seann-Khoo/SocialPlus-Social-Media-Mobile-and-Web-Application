...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circleImageView = findViewById(R.id.editProfileImage);
        profileName = findViewById(R.id.editProfileNameET);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    if (task.getResult().exists()){
                        ...
                        Glide.with(EditProfileActivity.this).load(profile).into(circleImageView);
                    }
                }
            }
        });
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || name.equals(" ")){
                    Toast.makeText(EditProfileActivity.this, "Please Insert Profile Name",Toast.LENGTH_SHORT).show();
                }
                if (ImageUri == null){
                    Toast.makeText(EditProfileActivity.this,"Please Select Profile Image",Toast.LENGTH_SHORT).show();
                }
                if (name.isEmpty() && ImageUri == null){
                    Toast.makeText(EditProfileActivity.this, "Please Select Profile Image and Insert Profile Name", Toast.LENGTH_SHORT).show();
                }
                if(!name.isEmpty() && ImageUri != null){
    ...
    private void saveToFireStore(Task<UploadTask.TaskSnapshot> task, String name, Uri downloadUri) {
        ...
        fireStore.collection("User Profile").document(Uid).set(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(EditProfileActivity.this, "Profile Information Updated", Toast.LENGTH_SHORT).show();
